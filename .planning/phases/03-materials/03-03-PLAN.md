...
<task type="auto">
  ...
  <files>materials/CROSS-REFERENCE-MATRIX.md</files>
  <action>
...
```
  ...
  <verify>
Check: ls materials/CROSS-REFERENCE-MATRIX.md confirms file exists
Check: grep -c '| \*\*' materials/CROSS-REFERENCE-MATRIX.md returns 13+ (all materials listed)
Check: grep 'Validation Commands' materials/CROSS-REFERENCE-MATRIX.md confirms validation section
  </verify>
  <done>
...
- ls materials/CROSS-REFERENCE-MATRIX.md confirms documentation exists
</verification>
